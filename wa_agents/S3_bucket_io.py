...
"""
Boto3 client arguments for both sync and async versions
"""
...
def b3_list_directories( prefix : str | Path) -> list[str] :
    ...
    for page in page_iter :
        for obj in page.get( "CommonPrefixes", []) :
            ...
            # else get relative path and take the first part
            if prefix_str == "" :
...
async def async_boto3_client() -> AsyncIterator[AsyncS3Client] :
    ...
    """
    async with aio_session.client(**boto3_client_args) as b3a :
...
def presign(
    ...
    return b3.generate_presigned_url(**arguments)
